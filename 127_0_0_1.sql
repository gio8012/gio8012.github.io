...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2024 a las 02:05:01
...
CREATE TABLE `tours` (
  ...
  `dias` int(3) NOT NULL,
  `transportes` int(3) NOT NULL,
  `estadia` int(3) NOT NULL
...
INSERT INTO `turista` (`id`, `apellidos`, `nombre`, `CI`, `edad`, `extranjero`, `dias`, `codigo`) VALUES
(102301, 'Roman Leaño', 'Jimena', '45618522', 52, 'Si', 3, 103),
(102302, 'Rodriguez Borja', 'Pedro', '56323457', 22, 'Si', 5, 201),
(102303, 'Marquez Guevara', 'Luisa', '34525433', 15, 'No', 10, 202),
(102304, 'Lemmang', 'Willbye', '23451244', 40, 'Si', 4, 204),
(102305, 'Da Silva Mori', 'Silvia', '35124235', 65, 'No', 5, 201),
(102306, 'Andrade Rojas', 'Roberto', '36542346', 85, 'No', 3, 102),
(102307, 'Rodriguez Lazo', 'Karina', '13534563', 12, 'No', 3, 104),
(102308, 'Chickendale', 'Giancarlo', '34523564', 30, 'Si', 5, 202),
(102309, 'Leon De Toledo', 'Maria Anita', '25647915', 65, 'No', 7, 201),
(102310, 'Teran Villa', 'Marco Aurelio', '84651451', 41, 'No', 6, 204),
(102311, 'Santamaria Soto', 'Gilberto', '867799123', 16, 'Si', 5, 203),
(102312, 'Del Carpio Paredes', 'Maria', '53489778', 21, 'No', 3, 104),
(102313, 'Scetti Bohn', 'Ferdinanda', '37479004', 32, 'Si', 8, 201);
...
--
ALTER TABLE `turista`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102314;
--
...
INSERT INTO `tours` (`Codigo`, `Tour`, `Dias`, `Transporte`, `Estadia`) VALUES
(101, 'Miami', 3, 600, 400),
(102, 'Cuzco', 3, 450, 350),
...
CREATE TABLE `turista` (
  ...
  `CI` varchar(10) NOT NULL COMMENT 'Carnet de Identidad',
  `Edad` int(3) NOT NULL,
  `Extrangero` tinyint(1) NOT NULL,
  `MenordeEdad` tinyint(1) NOT NULL,
  `Dias` int(3) NOT NULL,
  `Tour` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `turista` (`IdTurista`, `Apellidos`, `Nombres`, `CI`, `Edad`, `Extrangero`, `MenordeEdad`, `Dias`, `Tour`) VALUES
(102301, 'Román Leaño', 'Jimena', '45618522', 52, 1, 0, 3, '103');
...
--
ALTER TABLE `tours`
  MODIFY `Codigo` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;

--
-- AUTO_INCREMENT de la tabla `turista`
--
ALTER TABLE `turista`
  MODIFY `IdTurista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102302;
--
-- Base de datos: `automoviles`
--
CREATE DATABASE IF NOT EXISTS `automoviles` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `automoviles`;
...
INSERT INTO `automoviles` (`matricula`, `marca`, `modelo`, `color`, `precio`) VALUES
('2525252', 'Chevrolet', 'Small', '', 0),
('ABC-5678', 'Volkswagen', 'Jetta', 'Azul marino', 320000),
('ABC-7890', 'Audi', 'A4', 'Blanco Perla', 580000),
('ABCD-222', 'Nissan', '2010', 'blanco', 300000),
('HJK-3456', 'Toyota', 'Corolla', 'Blanco', 380000),
('JKL-678', 'Nissan', 'PIvo2', 'plateado', 500000),
('LMN-7890', 'Kia', 'Sportage', 'Negro', 420000),
('NLG-1234', 'Nissan', 'Versa', 'Plata', 250000),
('OPQ-1234', 'Honda', 'Civic', 'Gris', 300000),
('RST-5678', 'Ford', 'Mustang', 'Amarillo', 600000),
('UVW-9012', 'Mazda', 'CX-5', 'Verde', 450000),
('XYZ-3456', 'BMW', 'Serie 3', 'Azul cielo', 700000),
('XYZ-9012', 'Chevrolet', 'Silverado', 'Rojo', 550000);
...
INSERT INTO `clientes` (`codigo`, `nombre`, `direccion`, `cuidad`, `telefono`) VALUES
(1, 'Jose Luis', 'Apodaca', 'Monterrey', 558939290),
(2, 'Paola Hernandez', 'Toluca', 'Edo.Mex', 550039278),
(3, 'David Perez', 'Cuernavaca', 'Morelos', 556371281),
(4, 'Lucia Garcia', 'Mazatlan', 'Sinaloa', 557361188),
(5, 'Santiago Gomez', 'Tijuana', 'Baja California', 558371291),
(6, 'Agustin Cruz', 'Laredo', 'Nuevo Leon', 556432890),
(7, 'Sofia Mendoza', 'Puerto Escondido', 'Oaxaca', 553834891),
(8, 'Maria Espinoza', 'Cuidad del Carmen', 'Campeche', 556289398),
(9, 'Chloe Chavez', 'Villa Hermosa', 'Tabasco', 552378177),
(10, 'Bruno Torres', 'Coyoacan', 'CDMX', 553829832),
(11, 'Gisela', 'Nicolas Romero', 'Edo.Mex', 556616503),
(12, 'Gisela', 'Nicolas Romero', 'Edo.Mex', 556616503),
(13, 'Vanessa', 'Atizapan', 'EDOMEX', 2147483647),
(14, 'Angela', 'Atizapan', 'EDOMEX', 2147483647),
(15, 'juan', 'atizapan', 'edomex', 2147483647);
...
CREATE TABLE `revisiones` (
  `matricula` varchar(20) NOT NULL,
  `cambioFiltro` varchar(5) NOT NULL,
  `cambioAceite` varchar(5) NOT NULL,
  `cambioFrenos` varchar(5) NOT NULL,
...
INSERT INTO `revisiones` (`matricula`, `cambioFiltro`, `cambioAceite`, `cambioFrenos`, `otros`) VALUES
('NLG-1234', 'Si', 'No', 'Si', 'Cambio de llantas'),
('ABC-7890', 'No', 'No', 'Si', 'Sin especificaciones'),
('LMN-7890', 'No', 'Si', 'No', 'Sin especificaciones'),
('UVW-9012', 'No', 'No', 'Si', 'Cambio de retrovisores'),
('RST-5678', 'Si', 'Si', 'No', 'Sin especificaciones'),
('ABC-5678', 'No', 'No', 'Si', 'Sin especificaciones'),
('XYZ-3456', 'Si', 'Si', 'Si', 'Presion de neumaticos'),
('HJK-3456', 'No', 'No', 'No', 'Estado de amortiguadores'),
('FGH-789', 'Si', 'Si', 'Si', 'Alineacion de ruedas'),
('VWX-678', 'No', 'Si', 'Si', 'Sin especificaciones'),
('JKL-678', 'no', 'no', 'si', 'sin especificaciones'),
('ABCD-222', 'no', 'si', 'no', 'sin especificaciones'),
('2525252', 'no', 'si', 'si', 'nada');
...
--
-- Base de datos: `base_imc`
--
CREATE DATABASE IF NOT EXISTS `base_imc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `base_imc`;
...
CREATE TABLE `imc` (
  `clavep_imc` int(11) NOT NULL,
  `peso` float DEFAULT NULL,
  `altura` float DEFAULT NULL,
  `calc_imc` float DEFAULT NULL,
  `clavep_persona1` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `imc` (`clavep_imc`, `peso`, `altura`, `calc_imc`, `clavep_persona1`) VALUES
(1, 56, 1.78, 17.6745, 1);
...
CREATE TABLE `persona` (
  `clavep_persona` int(11) NOT NULL,
  ...
  `clavep_test1` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `persona` (`clavep_persona`, `nombre`, `ape_pa`, `ape_ma`, `edad`, `fecha_nac`, `sexo`, `clavep_test1`) VALUES
(1, 'gio', 'perez', 'ortega', 17, '12 de agosto del 2007', 'masculino', 1);
...
CREATE TABLE `plan_salud` (
  `clavep_plan_salud` int(11) NOT NULL,
  `dieta` varchar(100) DEFAULT NULL,
  `recomendaciones` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `plan_salud`
--

INSERT INTO `plan_salud` (`clavep_plan_salud`, `dieta`, `recomendaciones`) VALUES
(1, 'a', 'b'),
(2, 'x', 'y'),
(3, 'x', 'w');
...
CREATE TABLE `test` (
  `clavep_test` int(11) NOT NULL,
  `fecha` varchar(10) DEFAULT NULL,
  `resultado` int(11) DEFAULT NULL,
  `clavep_plan_salud1` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `test` (`clavep_test`, `fecha`, `resultado`, `clavep_plan_salud1`) VALUES
(1, '.14/10/24.', 25, 2);
...
--
ALTER TABLE `imc`
  ADD PRIMARY KEY (`clavep_imc`),
  ADD KEY `fk_clavep_persona1` (`clavep_persona1`);

--
-- Indices de la tabla `persona`
--
ALTER TABLE `persona`
  ADD PRIMARY KEY (`clavep_persona`),
  ADD KEY `fk_clavep_test1` (`clavep_test1`);

--
-- Indices de la tabla `plan_salud`
--
ALTER TABLE `plan_salud`
  ADD PRIMARY KEY (`clavep_plan_salud`);

--
-- Indices de la tabla `test`
--
ALTER TABLE `test`
  ADD PRIMARY KEY (`clavep_test`),
  ADD KEY `fk_clavep_plan_salud1` (`clavep_plan_salud1`);
...
--
ALTER TABLE `imc`
  MODIFY `clavep_imc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `persona`
--
ALTER TABLE `persona`
  MODIFY `clavep_persona` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `plan_salud`
--
ALTER TABLE `plan_salud`
  MODIFY `clavep_plan_salud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `test`
--
ALTER TABLE `test`
  MODIFY `clavep_test` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `imc`
  ADD CONSTRAINT `fk_clavep_persona1` FOREIGN KEY (`clavep_persona1`) REFERENCES `persona` (`clavep_persona`);

--
-- Filtros para la tabla `persona`
--
ALTER TABLE `persona`
  ADD CONSTRAINT `fk_clavep_test1` FOREIGN KEY (`clavep_test1`) REFERENCES `test` (`clavep_test`);

--
-- Filtros para la tabla `test`
--
ALTER TABLE `test`
  ADD CONSTRAINT `fk_clavep_plan_salud1` FOREIGN KEY (`clavep_plan_salud1`) REFERENCES `plan_salud` (`clavep_plan_salud`);
--
-- Base de datos: `bd1vehicular`
--
CREATE DATABASE IF NOT EXISTS `bd1vehicular` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd1vehicular`;
...
--
-- Estructura de tabla para la tabla `compraventa1`
--

CREATE TABLE `compraventa1` (
  `folio` int(11) NOT NULL,
  `id_vehiculo` int(11) NOT NULL,
  `id_cliente` int(11) NOT NULL,
  `id_empleado` int(11) NOT NULL,
...
ALTER TABLE `compraventa`
  ADD PRIMARY KEY (`id_vehiculo`,`id_cliente`,`id_empleado`);
...
('MATIAS', '');
--
-- Base de datos: `bdcontrolvehicular`
--
CREATE DATABASE IF NOT EXISTS `bdcontrolvehicular` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bdcontrolvehicular`;
...
--
-- Base de datos: `bdvehicular`
--
CREATE DATABASE IF NOT EXISTS `bdvehicular` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bdvehicular`;
...
INSERT INTO `cliente` (`IdCliente`, `Nombre`, `A_Paterno`, `A_Materno`, `Edad`, `Usuario`, `Password`) VALUES
(NULL, 'david', 'arizpe', 'navarrete', 17, 'nava', 11),
(NULL, 'jonathan', 'hernandez', 'rojas', 16, 'jonycalle3000pepe', 123456),
(NULL, 'ff', 'ff', 'ff', 12, 'tau', 1234);
--
-- Base de datos: `bdvincular`
--
CREATE DATABASE IF NOT EXISTS `bdvincular` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bdvincular`;
...
CREATE TABLE `usuario` (
  ...
  `codigo_ejemplar` int(21) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
--
-- Base de datos: `bitacora`
--
CREATE DATABASE IF NOT EXISTS `bitacora` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bitacora`;
...
CREATE TABLE `alumno` (
  `Numero de control` int(14) NOT NULL,
  `Nombre` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `alumno` (`Numero de control`, `Nombre`) VALUES
(2041, 'Jan'),
(3138, 'Kevin'),
(7212, 'Dante'),
(7414, 'Monse'),
...
CREATE TABLE `registro` (
  `Numero de control` int(30) NOT NULL,
  `Nombre` varchar(30) NOT NULL,
  `Hora de entrada` int(6) NOT NULL,
  `Fecha` int(11) NOT NULL,
  `Hora de salida` int(6) NOT NULL,
...
INSERT INTO `registro` (`Numero de control`, `Nombre`, `Hora de entrada`, `Fecha`, `Hora de salida`, `Telefono`) VALUES
(2041, 'Jan', 8, 13042024, 9, 74147212),
(3138, 'Kevin', 8, 13042024, 9, 67349823),
(7212, 'Dante', 8, 13042024, 9, 53870956),
(7414, 'Areli', 8, 13042024, 9, 84571283),
(7414, 'Monse', 8, 13042024, 9, 78345474);
...
--
ALTER TABLE `alumno`
  ADD PRIMARY KEY (`Numero de control`);

--
-- Indices de la tabla `registro`
--
ALTER TABLE `registro`
  ADD KEY `INDEX` (`Numero de control`);
--
-- Base de datos: `bitacoraame`
--
CREATE DATABASE IF NOT EXISTS `bitacoraame` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bitacoraame`;
...
INSERT INTO `registro` (`numcontrol`, `nombre`, `horaentrada`, `horasalida`, `fecha`) VALUES
('', NULL, '', '', ''),
('5082020491', 'Laura Valle Monrroy ', '7:00', '8:00', '25/04/24'),
('5082020492', 'Carolina Alvarez Galán', '10:40', '20:10', '25/04/24'),
('5082020493', 'María del Carmen Bonifacio Reyes', '9:00', '6:00', '25/04/24'),
('5082020494', 'José Mejía Velazques', '7:00', '12:20', '25/04/24'),
('5082020495', 'María Angela Peña', '7:00', '10:20', '25/04/24');
...
--
CREATE DATABASE IF NOT EXISTS `borrar` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `borrar`;
...
CREATE TABLE `cliente` (
  ...
  `Direccion` int(30) NOT NULL DEFAULT current_timestamp(),
  `Telefono` int(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Base de datos: `cliente1`
--
CREATE DATABASE IF NOT EXISTS `cliente1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cliente1`;
--
-- Base de datos: `coche`
--
CREATE DATABASE IF NOT EXISTS `coche` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `coche`;
--
-- Base de datos: `coleccion bd`
--
CREATE DATABASE IF NOT EXISTS `coleccion bd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `coleccion bd`;
...
--
CREATE DATABASE IF NOT EXISTS `concesionaria` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `concesionaria`;
...
(8574, 'Jan', 'Callejas', 'La Morelos', 342),
(7845, 'Monse', 'De Jesus', 'San Ilde', 345),
(5867, 'Areli', 'Elleyo', 'San Pedro', 876),
(6345, 'Ximena', 'Galicia', 'El crucero', 365),
(8465, 'Hanna', 'Arcia', 'Cantaros', 78);
...
(3344, 'Jeep wrangler', 'Jeep', 'Negro'),
(4785, 'Toyota prius', 'Toyota', 'Rojo'),
(7465, 'BMW serie 3', 'BMW', 'Azul'),
(7564, 'Tesla model', 'Tesla', 'Negro'),
(9465, 'Del rey', 'Ford', 'Blanco');
...
ALTER TABLE `coche`
  ADD PRIMARY KEY (`Matricula`);
--
-- Base de datos: `consultas_practica`
--
CREATE DATABASE IF NOT EXISTS `consultas_practica` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `consultas_practica`;
--
...
CREATE TABLE `atender` (
  ...
  `COD_MED` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `paciente` (
  ...
  `CO_POSTAL` varchar(100) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `realizo`
--

CREATE TABLE `realizo` (
  `codigo ingreso` varchar(100) NOT NULL,
...
--
ALTER TABLE `medico`
  MODIFY `COD_ME` int(11) NOT NULL AUTO_INCREMENT;
...
INSERT INTO `cliente` (`ID`, `nom`, `cia`) VALUES
(2, 'leo', 'xxx'),
(77, 'yoab', 'xxx'),
(4445, 'juan', 'mecanico');
...
--
ALTER TABLE `cliente`
  MODIFY `ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4446;
--
...
--
-- Estructura de tabla para la tabla `adornos`
--

CREATE TABLE `adornos` (
  `id_adornos` varchar(20) NOT NULL,
  `color` varchar(50) NOT NULL,
...
--
-- Volcado de datos para la tabla `adornos`
--

INSERT INTO `adornos` (`id_adornos`, `color`, `tipo`, `modelo`, `precio`, `material`) VALUES
('10', 'rosa', 'papel', 'flores', 20, 'pegamento-tijeras'),
('17', 'azul metalico', 'jarron', 'pintura', 15, 'plastico'),
('19', 'amarillo', 'pintura', 'hombre', 120, 'papel pinturas'),
('8', 'gris metalico', 'escultura', 'escultura', 150, 'porcelana y pintura');
...
CREATE TABLE `evento` (
  ...
  `id_paquete` varchar(50) NOT NULL,
  `id_adornos` varchar(50) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Estructura de tabla para la tabla `objeto_empeñado`
--

CREATE TABLE `objeto_empeñado` (
...
--
-- Estructura de tabla para la tabla `paqute`
--
...
CREATE TABLE `producto` (
  ...
  `fecha_caducidad` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `producto` (`id_producto`, `descripcion`, `lote`, `fecha_caducidad`) VALUES
(1, 'botella de agua\r\n', 5465, 2025),
(2, 'sabrita', 4576, 2024),
(3, 'aguacate', 455, 2024),
(4, 'manzana', 765, 2025),
...
--
-- Estructura de tabla para la tabla `tarjeta_de_circulacion`
--

CREATE TABLE `tarjeta_de_circulacion` (
  `id_circulacion` int(11) NOT NULL,
  `nombre` text NOT NULL,
...
--
-- Indices de la tabla `adornos`
--
ALTER TABLE `adornos`
  ADD PRIMARY KEY (`id_adornos`(15));
...
--
ALTER TABLE `celular`
  ADD PRIMARY KEY (`id_celular`(10),`id_compañia`,`id_paquete`(10));
...
--
ALTER TABLE `evento`
  ADD PRIMARY KEY (`id_evento`(10),`id_adornos`(10),`id_paquete`(10));
...
--
-- Indices de la tabla `objeto_empeñado`
--
ALTER TABLE `objeto_empeñado`
...
ALTER TABLE `prestamo`
  ...
  ADD KEY `cliente2` (`id_cliente2`),
  ADD KEY `objeto_empeñado` (`id_objeto`);
...
--
-- Indices de la tabla `tarjeta_de_circulacion`
--
ALTER TABLE `tarjeta_de_circulacion`
  ADD PRIMARY KEY (`id_circulacion`);
...
ALTER TABLE `verificacion`
  ...
  ADD KEY `automovil` (`id_automovil`),
  ADD KEY `tarjeta_de_circulacion` (`id_circulacion`);
...
ALTER TABLE `calificaciones`
  ...
  ADD CONSTRAINT `materias` FOREIGN KEY (`id_materias`) REFERENCES `materias` (`id_materias`);
...
ALTER TABLE `compra`
  ...
  ADD CONSTRAINT `producto` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`);

--
-- Filtros para la tabla `prestamo`
--
ALTER TABLE `prestamo`
  ADD CONSTRAINT `cliente2` FOREIGN KEY (`id_cliente2`) REFERENCES `cliente2` (`id_cliente`),
  ADD CONSTRAINT `objeto_empeñado` FOREIGN KEY (`id_objeto`) REFERENCES `objeto_empeñado` (`id_objeto`);

--
-- Filtros para la tabla `verificacion`
--
ALTER TABLE `verificacion`
  ADD CONSTRAINT `automovil` FOREIGN KEY (`id_automovil`) REFERENCES `automovil` (`id_automovil`),
  ADD CONSTRAINT `tarjeta_de_circulacion` FOREIGN KEY (`id_circulacion`) REFERENCES `tarjeta_de_circulacion` (`id_circulacion`);
--
-- Base de datos: `empleado`
--
CREATE DATABASE IF NOT EXISTS `empleado` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `empleado`;
...
INSERT INTO `clientes` (`dni`, `nombre`, `apellidos`, `direccion`, `fecNac`) VALUES
(1, 'Fatima', 'Nopalera', 'Cd/ Huasines s/n', '2007-01-26'),
(2, 'a', 'a', 'a', '2007-01-26'),
(3, 'Vanessa', 'Gonzalez', 'Atizapan', '0000-00-00'),
(4, 'Brenda', 'Rosas', 'Nicolas Romero', '0000-00-00'),
(5, 'Gisela', 'Matinez', 'Nicolas Romero', '02/04/2007'),
(6, 'rata', 'dadads', 'sdasas', '202020'),
(7, 'nayeli', 'sanchez', 'arboledas', '24/12/1998'),
(8, 'juan', 'dadads', 'atizapan', '202020');
...
(1, 'Juan', 'Cd/ Huasines s/n'),
(2, 'a', 'a'),
(3, 'Pedro', 'Nicolas Romero'),
(4, 'rata', 'sdasas'),
(5, 'juan', 'atizapan');
...
--
ALTER TABLE `clientes`
  MODIFY `dni` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `proveedores`
  MODIFY `nif` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
CREATE TABLE `alumno` (
  ...
  `edadalu` int(3) NOT NULL,
  `semalu` int(1) NOT NULL,
  `genalu` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `alumno` (`numc`, `nomalu`, `edadalu`, `semalu`, `genalu`) VALUES
(1, 'María José', 16, 3, 'F'),
(2, 'Fernando', 14, 3, 'M'),
(10, 'María Angela', 15, 5, 'F'),
(101, 'Juan Carlos', 17, 5, 'M'),
(102, 'Mauricio', 18, 5, 'M'),
(103, 'José Francisco', 14, 5, 'M'),
(104, 'María de los Angeles', 18, 5, 'F'),
(105, 'Brenda Dalay ', 17, 5, 'F'),
(106, 'Brenda Jazmin', 17, 5, 'F'),
(110, 'Diana', 18, 3, 'F'),
(111, 'Diana Alejandra', 17, 5, 'F'),
(134, 'Jose', 17, 3, 'M'),
(202, 'Vanessa ', 17, 5, 'F'),
(231, 'Adrian', 18, 3, 'M');
...
-- Base de datos: `evol`
--
CREATE DATABASE IF NOT EXISTS `evol` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `evol`;
--
-- Base de datos: `ingrid`
--
CREATE DATABASE IF NOT EXISTS `ingrid` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ingrid`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ing`
--

CREATE TABLE `ing` (
  `Nombre` int(20) NOT NULL,
  `apellido_p` int(20) NOT NULL,
  `apellido_m` int(20) NOT NULL,
  `Edad` int(20) NOT NULL,
  `Usuario` int(20) NOT NULL,
  `Password` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
--
-- Base de datos: `iniciaar sesión`
--
CREATE DATABASE IF NOT EXISTS `iniciaar sesión` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `iniciaar sesión`;
...
--
-- Base de datos: `iniciar sesion`
--
CREATE DATABASE IF NOT EXISTS `iniciar sesion` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `iniciar sesion`;
...
CREATE TABLE `registrarse` (
  `nombre` int(11) NOT NULL,
  `apellido` int(11) NOT NULL,
  `segundo apellido` int(11) NOT NULL,
  `tele` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
--
-- Base de datos: `iniciar sesión`
--
CREATE DATABASE IF NOT EXISTS `iniciar sesión` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `iniciar sesión`;
...
--
-- Base de datos: `inicio_lian`
--
CREATE DATABASE IF NOT EXISTS `inicio_lian` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `inicio_lian`;
...
INSERT INTO `usuario` (`nombre`, `edad`, `telefono`, `correo`, `direccion`) VALUES
('', 23, 4334, 'fgdddf', 'jdfgd'),
('', 17, 3456664, 'lian@gmail.com', 'nicolas romero'),
('', 17, 3456664, 'lian@gmail.com', 'nicolas romero'),
('', 17, 3456664, 'lian@gmail.com', 'nicolas romero'),
('', 16, 3456664, 'maria@gmail.com', 'atizapan'),
('', 34, 34654, 'jose@gmail.com', 'hidalgo'),
('', 40, 555476, 'jose@gmail', 'atizapan'),
('', 40, 555476, 'jose@gmail', 'atizapan'),
('', 40, 555476, 'jose@gmail', 'atizapan'),
('', 18, 343567, 'jope@gmal', 'nicolas romero'),
('', 55, 54677, 'lfgkgjj', 'dskjgs'),
('', 72, 13454, 'lyu', 'dhjb'),
('', 35, 5779, 'gkg', 'dhg'),
('', 345, 4385, 'bdsfj', 'gfaui');
--
-- Base de datos: `labonita`
--
CREATE DATABASE IF NOT EXISTS `labonita` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `labonita`;
...
INSERT INTO `empleados` (`idEmpleado`, `nombre`, `apellidos`, `genero`, `sueldo`) VALUES
(1, 'Carlos', 'Jimenez Clarin', 'H', 1500),
(2, 'Elena', 'Rubio Cuestas', 'M', 1300),
(3, 'Jose', 'Calvo Sisman', 'H', 1400),
(4, 'Margarita', 'Rodriguez Garces', 'M', 1325),
(5, 'Josefina', 'Cortes Rubio', 'M', 1200),
(6, 'Carmen', 'Rodriguez Lopez', 'M', 1300),
(7, 'Julian', 'Jimenez Hernandez', 'H', 1500),
(8, 'Elena', 'Rebollar Torres', 'M', 1400),
(9, 'Jose', 'Mendez Aguilar', 'H', 1325),
(10, 'Jonathan', 'Mendez Aguilar', 'H', 1325);
...
CREATE TABLE `producto` (
  `codigoP` int(3) NOT NULL,
  `nombre` varchar(50) NOT NULL,
  `precioU` int(3) NOT NULL,
...
INSERT INTO `producto` (`codigoP`, `nombre`, `precioU`, `cantidad`, `categoria`) VALUES
(100, 'Leche', 45, 2, 'Lacteo'),
(104, 'Galletas', 35, 9, 'Dulceria'),
(202, 'Queso', 35, 3, 'Lacteo'),
(305, 'Agua', 17, 7, 'Abarrotes'),
(414, 'Refresco', 35, 45, 'Abarrotes'),
(525, 'Chicles', 45, 8, 'Dulceria'),
(612, 'Aceite', 50, 6, 'Abarrotes'),
(745, 'Sopa', 12, 34, 'Abarrotes'),
(848, 'Crema', 28, 5, 'Lacteo'),
(987, 'Jugo', 35, 8, 'Abarrotes');
...
--
ALTER TABLE `empleados`
  MODIFY `idEmpleado` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- Base de datos: `mariaa`
--
CREATE DATABASE IF NOT EXISTS `mariaa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mariaa`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `maria`
--
...
--
-- Base de datos: `mototrizlian`
--
CREATE DATABASE IF NOT EXISTS `mototrizlian` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mototrizlian`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `motoclia`
--

CREATE TABLE `motoclia` (
...
--
-- Volcado de datos para la tabla `motoclia`
--

INSERT INTO `motoclia` (`marca`, `modelo`, `precio`, `Cilindraje`) VALUES
('pulsar', 'pulsar200ns', 59, '199.50 cc.'),
('pulsar', 'pulsar160', 48, '160cc'),
('pulsar', 'dominar', 69, '373cc'),
('ktm', 'ktm390', 138900, '373cc'),
('ktm', 'ktm390', 138900, '373cc');
--
...
INSERT INTO `clientes` (`dni`, `nombre`, `apellido`, `direccion`, `fechaNac`) VALUES
(100, 'Luis', 'Testas', 'Colmena', '23/Sep/79'),
(299, 'Tomas', 'Piña', 'Naucalpan', '12/Sep/201'),
(300, 'Cesar', 'Aquirre', 'Dubai', '07/Oct/21'),
(301, 'Marta', 'Cruz', 'New york', '09/Sep/11'),
(358, 'Pedro', 'Infante', 'Izcalli', '06/feb/55'),
(402, 'Agustin', 'inturbide', 'Malvinas', '06/feb/99'),
(599, 'Carlos', 'tercero', 'tlaxcala', '05/May/05'),
(616, 'Alonso', 'Cabral', 'Clara cordova', '15/sep/200'),
(666, 'juan', 'Escutia', 'Granjas', '11/Ene/07'),
(777, 'Maria', 'Angeles', 'tlane', '14/feb/01');
...
--
CREATE DATABASE IF NOT EXISTS `paqueteria` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `paqueteria`;
...
INSERT INTO `camioneros` (`dni_camionero`, `nombre`, `telefono`, `direccion`) VALUES
(123, 'Pancho', 2147483647, 'Nicolas Romero'),
(139, 'Paloma', 2147483647, 'Atizapan'),
(893, 'Ulises', 2147483647, 'Nicolas Romero');
...
CREATE TABLE `camiones` (
  `mat_camiones` int(11) NOT NULL,
  `modelo` varchar(40) NOT NULL,
  `tipo_potencia` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `provincia` (
  `codigo_paquetes` int(11) NOT NULL,
  `nombre` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `provincia`
  ADD PRIMARY KEY (`codigo_paquetes`);
--
-- Base de datos: `paqueteria1`
--
CREATE DATABASE IF NOT EXISTS `paqueteria1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `paqueteria1`;
--
...
('cliente', 'Apellido', 'varchar', '20', 'utf8mb4_general_ci', 0, ',', ''),
('cliente', 'Dirección', 'int', '30', '', 0, ',', 'current_timestamp()');
...
('root', '[{\"db\":\"northwind\",\"table\":\"categories\"},{\"db\":\"northwind\",\"table\":\"customercustomerdemo\"},{\"db\":\"northwind\",\"table\":\"customerdemographics\"},{\"db\":\"northwind\",\"table\":\"employees\"},{\"db\":\"northwind\",\"table\":\"customers\"},{\"db\":\"northwind\",\"table\":\"orders\"},{\"db\":\"northwind\",\"table\":\"shippers\"},{\"db\":\"northwind\",\"table\":\"region\"},{\"db\":\"northwind\",\"table\":\"products\"},{\"db\":\"northwind\",\"table\":\"suppliers\"}]');
...
('ejemplos', 'calificaciones', 'promedio'),
('ejemplos', 'compra', 'id_compra'),
('ejemplos', 'producto', 'id_producto'),
('ejemplos', 'verificacion', 'resultado');
...
('root', 'concesionaria', 'cliente', '[]', '2024-05-25 18:00:21'),
('root', 'ejemplos', 'producto', '{\"CREATE_TIME\":\"2024-08-26 08:23:46\",\"col_order\":[0,1,2,3],\"col_visib\":[1,1,1,1]}', '2024-09-02 13:43:27');
...
('root', '2024-09-10 14:01:54', '{\"Console\\/Mode\":\"show\",\"lang\":\"es\",\"Console\\/Height\":54.93949}');
...
--
CREATE DATABASE IF NOT EXISTS `practica1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `practica1`;
...
CREATE TABLE `adornos` (
  `id_adornos` int(10) NOT NULL,
  `tematica` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `calificacione`
--
...
CREATE TABLE `celular` (
  `id_celular` int(10) NOT NULL,
  `numero` varchar(1) NOT NULL,
  `veneficiario` int(5) NOT NULL,
...
CREATE TABLE `costo` (
  `id_costo` int(20) NOT NULL,
  `id_ropa` int(10) NOT NULL,
  `prenda` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `marerias`
--

CREATE TABLE `marerias` (
...
CREATE TABLE `paquete` (
  ...
  `ayuda al cliente` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `servicios` (
  ...
  `ayuda al cliente` int(3) NOT NULL,
  `atencion` int(3) NOT NULL,
  `nombre` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `verificacion` (
  ...
  `id_verificacion` int(10) NOT NULL,
  `id_licensia` int(10) NOT NULL,
...
--
ALTER TABLE `adornos`
  ADD PRIMARY KEY (`id_adornos`,`tematica`,`ubicacion`,`fecha`,`hora`);

--
-- Indices de la tabla `alumnos`
--
ALTER TABLE `alumnos`
  ADD PRIMARY KEY (`id_alumno`,`nombre`,`apellidos`,`semestre`);

--
-- Indices de la tabla `automovil`
--
ALTER TABLE `automovil`
  ADD PRIMARY KEY (`id_automovil`,`marca`,`año`,`seguro`);

--
-- Indices de la tabla `calificacione`
--
ALTER TABLE `calificacione`
  ADD PRIMARY KEY (`id_alumno`,`nombre`,`apellidos`,`num.lista`,`materia`);

--
-- Indices de la tabla `celular`
--
ALTER TABLE `celular`
  ADD PRIMARY KEY (`id_celular`,`numero`,`veneficiario`,`nombre`);

--
-- Indices de la tabla `cliente`
--
ALTER TABLE `cliente`
  ADD PRIMARY KEY (`id_cliente`,`nombre`,`direccion`,`telefono`);

--
-- Indices de la tabla `costo`
--
ALTER TABLE `costo`
  ADD PRIMARY KEY (`id_costo`,`id_ropa`,`prenda`,`talla`);

--
-- Indices de la tabla `empleado`
--
ALTER TABLE `empleado`
  ADD PRIMARY KEY (`id_empleado`,`apellido_p`,`apellido_m`,`edad`,`horario`);

--
-- Indices de la tabla `evento`
--
ALTER TABLE `evento`
  ADD PRIMARY KEY (`id_evento`,`ubicacion`,`fecha`,`hora`);

--
-- Indices de la tabla `licencia`
--
ALTER TABLE `licencia`
  ADD PRIMARY KEY (`id_licensia`,`nombre`,`vigencia`,`estado`);

--
-- Indices de la tabla `marerias`
--
ALTER TABLE `marerias`
  ADD PRIMARY KEY (`id_maestro`,`nombre`,`trabajos`,`asistencias`);

--
-- Indices de la tabla `paquete`
--
ALTER TABLE `paquete`
  ADD PRIMARY KEY (`id_servicio`,`garantia`,`saldo`,`ayuda al cliente`);

--
-- Indices de la tabla `prenda`
--
ALTER TABLE `prenda`
  ADD PRIMARY KEY (`id_prenda`,`color`,`talla`,`precio`);

--
-- Indices de la tabla `producto`
--
ALTER TABLE `producto`
  ADD PRIMARY KEY (`id_producto`,`descripcion`,`cantidad`,`precio`);

--
-- Indices de la tabla `ropa`
--
ALTER TABLE `ropa`
  ADD PRIMARY KEY (`id_ropa`,`tamaño`,`color`,`tipo de tela`,`precio`);
...
--
ALTER TABLE `venta`
  ADD PRIMARY KEY (`id_venta`,`cliente`,`producto`,`fecha`);

--
-- Indices de la tabla `verificacion`
--
ALTER TABLE `verificacion`
  ADD PRIMARY KEY (`id_automovil`,`id_verificacion`,`id_licensia`,`precio`,`placa`);
...
CREATE TABLE `arbitros` (
  `id-albitros` varchar(10) NOT NULL,
  `nombre` varchar(30) NOT NULL,
  `sueldo` int(5) NOT NULL,
  `edad` varchar(15) NOT NULL,
  `años de  experiencia` int(5) NOT NULL,
...
INSERT INTO `arbitros` (`id-albitros`, `nombre`, `sueldo`, `edad`, `años de  experiencia`, `nacionalidad`) VALUES
('5', 'emanuel sanchez', 1000, '30', 5, 'mexicana'),
('dos', 'emanuel sanchez', 1000, '30', 5, 'mexicana');
...
CREATE TABLE `clasificacion` (
  ...
  `partidos jugados` int(5) NOT NULL,
  `partidos ganados` int(5) NOT NULL,
  `partidos perdidos` int(5) NOT NULL,
  `id_equipo` varchar(10) NOT NULL,
  `goles a favor` int(10) NOT NULL,
  `goles en contra` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cuerpos tecnicos`
--

CREATE TABLE `cuerpos tecnicos` (
  `id_cuerpos tecnicos` varchar(15) NOT NULL,
  `nombre` varchar(30) NOT NULL,
  `sueldo` int(8) NOT NULL,
  `tiempo de contrato` varchar(10) NOT NULL,
...
CREATE TABLE `horarios` (
  ...
  `id_equipo 1` varchar(10) NOT NULL,
  `id_equipo 2` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `jugadores` (
  `id_jugador` varchar(17) NOT NULL,
  `pocision` varchar(10) NOT NULL,
  `nombre` varchar(30) NOT NULL,
  `sueldo` int(5) NOT NULL,
...
CREATE TABLE `lugar` (
  `id_lugar` varchar(10) NOT NULL,
  `nombre de lugar` varchar(15) NOT NULL,
  `direccion` varchar(50) NOT NULL,
  `precio entradas` int(5) NOT NULL,
...
INSERT INTO `lugar` (`id_lugar`, `nombre de lugar`, `direccion`, `precio entradas`, `capacidad`) VALUES
('5', 'san ilde fonso', 'carretera nicolas romero', 2000, 1);
...
CREATE TABLE `marcadores` (
  `tarjetas amarillas` int(5) NOT NULL,
  `tarjetas rojas` int(2) NOT NULL,
  `goles` int(15) NOT NULL,
  `tiempo de partido` int(8) NOT NULL,
  `id_equipo` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `patrocinadores` (
  `id_patrocinador` varchar(10) NOT NULL,
  `nombre` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `patrocinadores` (`id_patrocinador`, `nombre`) VALUES
('5', 'susana jimenez');
...
--
-- Indices de la tabla `cuerpos tecnicos`
--
ALTER TABLE `cuerpos tecnicos`
  ADD PRIMARY KEY (`id_cuerpos tecnicos`);
...
ALTER TABLE `marcadores`
  ADD PRIMARY KEY (`tarjetas amarillas`);
...
--
ALTER TABLE `horarios`
  MODIFY `fecha` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `marcadores`
--
ALTER TABLE `marcadores`
  MODIFY `tarjetas amarillas` int(5) NOT NULL AUTO_INCREMENT;
--
-- Base de datos: `practica3`
--
CREATE DATABASE IF NOT EXISTS `practica3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `practica3`;
...
CREATE TABLE `tblusuario` (
  ...
  `acrtivo` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tblusuario` (`idx`, `usuario`, `nombre`, `sexo`, `nivel`, `email`, `telefono`, `marca`, `compañia`, `saldo`, `acrtivo`) VALUES
(1, 'BRE4677', 'BRENDA', 'M', 3, 'brenda@gmail.com', '655-123-5898', 'SAMSUMG', 'TELCEL', 100, 1),
(2, 'OSC4623', 'OSCAR', 'H', 3, 'oscar@gmail.com', '655-323-5567', 'LG', 'TELCEL', 100, 1),
(3, 'JOS7086', 'JOSE', 'H', 3, 'jose@7live.com', '655-143-5706', 'NOKIA', 'MOVISTAR', 50, 1),
(4, 'LUI6115', 'LUIS', 'H', 0, 'luis@gmail.com', '655-143-9360', 'SAMSUMG', 'TELCEL', 100, 0),
(5, 'LUI7072', 'LUIS', 'H', 3, 'luis@hotmail.com', '655-110-6746', 'NOKIA', 'IUSACELL', 30, 1),
(6, 'DAN3456', 'DANIEL', 'H', 1, 'daniel@outlook.com', '655-370-4566', 'SONY', 'UNEFON', 50, 1),
(7, 'JAQ0987', 'JAQUELIN', 'M', 1, 'jaquelin@outlook.com', '655-690-1810', 'BLACKBERRY', 'IUSACELL', 0, 1),
(8, 'ROM1234', 'ROMAN', 'H', 3, 'roman@gmail.com', '655-340-5797', 'LG', 'TELCEL', 20, 1);
...
CREATE TABLE `apoyo` (
  ...
  `edad` int(3) NOT NULL,
  `justifica` varchar(150) NOT NULL,
...
INSERT INTO `apoyo` (`codigo`, `nombre`, `apellidos`, `correo`, `edad`, `justifica`, `cantidad`) VALUES
(1, 'Vanessa', 'Gonzalez', 'gatitomiuw@gmail.com', 58, 'Para ayudar a los de bajos recursos', 400),
(2, 'Vanessa', 'Gonzalez', 'gatitomiuw@gmail.com', 58, 'Para ayudar a los de bajos recursos', 400),
(3, 'Vanessa', 'Gonzalez', 'gatitomiuw@gmail.com', 58, 'Para ayudar a los de bajos recursos', 400),
(4, 'Vanessa', 'Gonzalez', 'gatitomiuw@gmail.com', 58, 'Para ayudar a los de bajos recursos', 400);
...
INSERT INTO `clientes` (`codigo`, `nombre`, `direccion`, `correo`, `telefono`) VALUES
(1, 'Vanessa Gonzalez', 'Atizapan', '', 2147483647),
(2, 'Vanessa Gonzalez', 'Atizapan', 'gatitomiuw@gmail.com', 2147483647),
(3, 'Fatima Nopalito', 'Palomos', 'nopalitoardillita@gmail.com', 2147483647);
...
--
-- Base de datos: `proyecto_lorena`
--
CREATE DATABASE IF NOT EXISTS `proyecto_lorena` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `proyecto_lorena`;
...
-- Base de datos: `quit`
--
CREATE DATABASE IF NOT EXISTS `quit` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `quit`;
--
...
INSERT INTO `clientes` (`DNI`, `NOMBRE`, `APELLIDO`, `DIRECCION`, `FECHA`) VALUES
(1, 'SOFIA', 'ARMONA', 'AV JUAREZ', '20/09/2000');
...
CREATE TABLE `comprar` (
  ...
  `DNI_CLIENTES` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `registro` (`nombre`, `apellido`, `telefono`, `contraseña`) VALUES
('', '', '', ''),
('', '', '', ''),
('', '', '', ''),
('', '', '', ''),
...
USE `test`;
--
-- Base de datos: `tienda_nombre`
--
CREATE DATABASE IF NOT EXISTS `tienda_nombre` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tienda_nombre`;
...
-- Base de datos: `tilin`
--
CREATE DATABASE IF NOT EXISTS `tilin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tilin`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kaiser`
--
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `edad`, `correo`, `categoria`, `clave`) VALUES
('1d', 'uriel', 16, 'urimmm@gmail.com', 'administrador', '1234susan'),
('2d', 'susi', 17, 'susisss@gmail.com', 'secretaria', '1235'),
('3d', 'noemi', 16, 'noemiiii@gmail.com', 'capturista', '2222');
